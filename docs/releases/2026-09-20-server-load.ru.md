...
## Последующая глобальная сверка20.09

Установка мониторинга и UI не закрывает этап4 и не означает выполненный этап6.
Три публичные загрузки проверены предыдущим отчётом, но public Linux11c53d18c3bc10a9
отстаёт от установленного c55149740c24618c. При сверке новых runtime-тестов,
установок и серверных действий нет; rollout/rollback и ограничения выше прежние.
Основные release gates: физический Windows, российская сеть, длительная устойчивость
и самостоятельная установка Linux. Независимая доставка конфигураций/смена gateway
остаётся следующей инфраструктурной работой, доступной без Windows-компьютера.
