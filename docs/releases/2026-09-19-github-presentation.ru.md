...
Оформление опубликовано в main коммитом `9c4114b` (38 файлов). Публичный README
скачан с GitHub и побайтно совпал с проверенной версией. Проверены 602 локальные
ссылки в 36 Markdown-файлах, 17 внешних URL (HTTP200), четыре Mermaid-диаграммы.
Отдельная проверка scope/типовых secret patterns прошла; это не аудит всей истории.
Новые Client builds/Android сборки этим документационным коммитом не инициированы.
About остаётся `vpn_service`: нет авторизованного API, команда владельцу ниже.
