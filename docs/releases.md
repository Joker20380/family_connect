...
## Manual downloads — 2026-09-20

Invitation page now links Android beta25, Linux paired11c53d18c3bc10a9 with shared
navigation, and Windows preview21b740a. Linux is a manual source bundle requiring
separate VPN helpers; Windows physical acceptance is pending. Immutable preview
URLs do not replace stable v0.2.9 or signed automatic update catalogs.
[Exact files, validation and rollback](releases/2026-09-20-three-platform-downloads.ru.md).
