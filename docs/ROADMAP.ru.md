...
4. По подтверждённому порядку: завершить Windows (AWG/переключение транспортов и full-routing acceptance), затем Android transports.
