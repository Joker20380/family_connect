...
**Сейчас: этап 4 — комплект Linux amd64 прошёл чистую установку с настоящим systemd в Debian-контейнере; TCP 0.1.0 опубликован и подписан, HTTPS-доставка проверена; системный установщик/UI Linux-пилота проверены на ноутбуке; далее CI/клиентский выпуск и остальные платформы.**
...
4. Ревью и интеграция в main выполнены, 226 tests passed. Далее отдельная упаковка
   ...
   Далее platform CI, новый client release/доставка bootstrap, VM и native платформы.
