...
**Сейчас: TCP-код интегрирован в main; этап 4 — упаковка, установка и платформенная интеграция.**
...
| 4. Платформы и стабильный выпуск | **Текущий этап: чистая установка Linux, затем Windows/Android** | Linux/Windows/Android: native интеграция, установка, переключение, отмена, восстановление; platform CI, UI/runtime, подписанный неизменяемый релиз |
...
4. Ревью и интеграция в main выполнены, 226 tests passed. Далее отдельная упаковка
   TCP-компонентов для чистого Linux, native платформы/CI и новый подписанный выпуск.
