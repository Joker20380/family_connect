...
**Сейчас: этап 4 — комплект Linux amd64 прошёл чистую установку с настоящим systemd в Debian-контейнере; TCP 0.1.0 опубликован и подписан, HTTPS-доставка проверена; далее системный установщик/UI и остальные платформы.**
...
| 4. Платформы и стабильный выпуск | **TCP 0.1.0 подписан/опубликован; broker/UI, VM и Windows/Android впереди** | Linux/Windows/Android: native интеграция, установка, переключение, отмена, восстановление; platform CI, UI/runtime, подписанный неизменяемый релиз |
...
4. Ревью и интеграция в main выполнены, 226 tests passed. Далее отдельная упаковка
   ...
   Далее broker/UI, отдельная VM/оборудование и native платформы.
