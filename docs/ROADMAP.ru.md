...
**Сейчас: этап 4 — комплект Linux amd64 прошёл чистую установку с настоящим systemd в Debian-контейнере; впереди подписанная доставка и остальные платформы.**
...
| 4. Платформы и стабильный выпуск | **Linux systemd-контейнер проверен; доставка, VM/оборудование и Windows/Android впереди** | Linux/Windows/Android: native интеграция, установка, переключение, отмена, восстановление; platform CI, UI/runtime, подписанный неизменяемый релиз |
...
4. Ревью и интеграция в main выполнены, 226 tests passed. Далее отдельная упаковка
   ...
   Далее подписанная доставка, отдельная VM/оборудование, native платформы/CI и новый выпуск.
