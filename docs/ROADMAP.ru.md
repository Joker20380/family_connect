...
**Сейчас: этап4. Desktop0.2.9 опубликован, exact platform CI прошёл, catalog sequence8 подписан офлайн. На устройствах обновление ещё не применялось. TCP Setup0.1.0 опубликован с отдельной офлайн-подписью. Windows TCP-движок прошёл изолированную приёмку TUN/VLESS 12/12 и очистку. Далее Windows broker, REALITY-профиль, маршруты/DNS и UI/fallback, затем AWG/Android transports; Android updater отложен. Сетевые тайм-ауты остаются известным ограничением; нагрузочные испытания отложены пользователем.**
...
4. Windows TCP: движок/TUN прошли CI; далее broker/REALITY/маршруты/DNS/UI, AWG и Android. Затем реальная Reticulum-доставка и независимый gateway.
