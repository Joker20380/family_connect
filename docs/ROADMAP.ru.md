...
**Сейчас: этап4. Функциональность WG/AWG/TCP подтверждена в Linux-пилоте, стабильность host-нагрузки остаётся открытой. Пользователь отложил сетевые испытания. Standalone setup интегрирован в main;273 tests и GTK recovery прошли. Source180d79f отправлен, все platform/TCP/AWG/phase0 CI прошли; дальше новый versioned release и доверенная публикация setup/клиента.**
...
3. Доверенная immutable поставка setup и новый client release после проверки артефактов.
