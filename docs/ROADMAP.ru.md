...
4. По подтверждённому порядку: Windows transport implementation завершена и принята в scoped CI; Android WG/AWG принят в API35 эмуляторе (24 UDP, остановки, отмена, системный отзыв); далее TCP и Auto. Full-routing/device acceptance остаётся условием выпуска, отложенные тесты не возобновлять автоматически.
