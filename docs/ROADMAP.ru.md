...
**Сейчас: этап 4 — комплект Linux amd64 собран и проверен на файловой установке; впереди чистая systemd-система и остальные платформы.**
...
| 4. Платформы и стабильный выпуск | **Комплект Linux готов; booted-systemd приёмка и Windows/Android впереди** | Linux/Windows/Android: native интеграция, установка, переключение, отмена, восстановление; platform CI, UI/runtime, подписанный неизменяемый релиз |
...
4. Ревью и интеграция в main выполнены, 226 tests passed. Далее отдельная упаковка
   TCP-компонентов создана, 229 tests passed; далее чистая systemd-машина,
   native платформы/CI и новый подписанный выпуск.
