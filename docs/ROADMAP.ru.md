...
**Сейчас: этап4. Функциональность WG/AWG/TCP подтверждена в Linux-пилоте, стабильность host-нагрузки остаётся открытой. Пользователь отложил сетевые испытания. Standalone setup интегрирован в main;273 tests и GTK recovery прошли. Дальше source checkpoint, platform CI и доверенная публикация setup/нового клиента.**
...
2. Интеграция setup и ревью client patch выполнены; далее source checkpoint/platform CI.
