...
**Сейчас: этап4. Desktop0.2.9 опубликован, exact platform CI прошёл, catalog sequence8 подписан офлайн. На устройствах обновление ещё не применялось. Следующие задачи: доверенная первичная поставка TCP Setup и native Windows/Android transports. Сетевые тайм-ауты остаются известным ограничением; нагрузочные испытания отложены пользователем.**
...
3. Client0.2.9 опубликован; далее доверенная immutable initial-поставка TCP Setup.
