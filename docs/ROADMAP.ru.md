...
4. По подтверждённому порядку: завершить Windows (автоматическое переключение транспортов; full-routing acceptance до выпуска), затем Android transports.
