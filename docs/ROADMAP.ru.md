...
**Сейчас: функциональная приёмка Linux-пилота этапа 3 пройдена; переходим к ревью и интеграции перед этапом 4.**
...
| 3. TCP VLESS+REALITY | **Функциональная приёмка Linux пройдена; впереди ревью/integration** | Понятны оставшиеся тайм-ауты; исправленный helper проходит короткий host-тест, точную очистку и established AWG → TCP recovery |
...
4. Провести ревью и интеграцию экспериментальной ветки; затем актуальные проверки,
   перенос транспортов на остальные платформы и подписанные обновления.
