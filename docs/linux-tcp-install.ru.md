...
доверенного издателя. Не запускать root-installer из неизвестного архива. Проверка подписи реализована в отдельном [CLI](tcp-delivery.ru.md), публичного
подписанного каталога ещё нет; текущие результаты не разрешают
