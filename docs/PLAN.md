...
5.3а остаётся текущим шагом;5.3в.1 можно выполнять без телефона параллельно по
очереди локальных работ. Реализация5.3в.2 зависит от выбора проверенного входа,
