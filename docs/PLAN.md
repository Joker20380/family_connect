...
Windows0.2.13 опубликован после замечаний пользователя к разметке0.2.10, старому
логотипу, регистрации и системному оформлению списков. [Приёмка](releases/2026-09-23-windows0213-updater.ru.md).
...
Windows0.2.13 опубликован после сообщения о белых вспышках при выборе страны/транспорта в0.2.11. Буферизация списков и контейнеров, единое обновление layout и отсутствие промежуточного появления активации проверены в native CI. Повторная проверка плавности на ПК пользователя остаётся открытой.

Windows0.2.13 и отдельный подписанный канал опубликованы. Следующий шаг: одна ручная установка на пользовательском ПК, затем проверка кнопки обновления. Windows schema2/sequence9 отделён от старого общего schema1/sequence8. [Проверки и выпуск](releases/2026-09-23-windows0213-updater.ru.md).
