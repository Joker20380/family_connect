...
| 5. Служебный канал и парк серверов | В работе:5.1 завершён;5.2 backend/SSH/scheduler/offline publish подготовлены;5.3а managed AWG3.1 требует native/Friends integration и device acceptance. Сейчас — секреты/recovery, затем возврат к5.3а |
