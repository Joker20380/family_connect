...
Windows0.2.11 опубликован после замечаний пользователя к разметке0.2.10, старому
логотипу, регистрации и системному оформлению списков. [Приёмка](releases/2026-09-23-windows0211-dpi.ru.md).
