...
(bundle c55149740c24618c) установлен с новой картой, интерактивным кругом
и шкалой нагрузки. Публичный архив пока11c53d18c3bc10a9 — без новой шкалы.
...
Мониторинг CPU/RX/TX работает на RU/NL; ёмкость каналов неизвестна, общий процент
пока недоступен. Сам мониторинг не закрывает распределение пользователей/этап6.
[Точная версия и проверки](releases/2026-09-20-server-load.ru.md).
