...
| Windows x64 | 0.2.11 / preview8906d62 | GitHub/HTTPS installer; native CI passed; повторная проверка на ПК пользователя ожидается |
...
сохранены; Linux0.2.10 и Windows0.2.11 распространяются как manual preview.

[Версии и хеши](releases.md) · [Windows: приёмка и откат](releases/2026-09-23-windows0211-dpi.ru.md) · [Android/Linux](releases/2026-09-23-switch-colors-beta50.ru.md).
...
Windows0.2.10 не прошёл физическую UI-проверку пользователя. Исправление0.2.11
опубликовано: DPI/растягивание окна, собственные списки и кнопки, новый логотип,
автоматическое создание ключа и понятная активация по приглашению. Native CI пройден;
повторная проверка на его ПК ещё нужна. [Артефакт, проверки и откат](releases/2026-09-23-windows0211-dpi.ru.md).

Пользователь сообщил мерцание Windows0.2.11 при смене настроек. В работе [кандидат0.2.12](releases/2026-09-23-windows0212-repaint.ru.md); физическая UI-приёмка пока не закрыта.
