...
| Windows x64 | 0.2.13 / sourcec298436 | GitHub/HTTPS installer; native CI passed; повторная проверка на ПК пользователя ожидается |
...
Пользователь выбрал одну ручную установку переходной версии. Native CI пройден; плавность
и обновление на его ПК ещё требуют подтверждения. [Артефакт, канал и откат](releases/2026-09-23-windows0213-updater.ru.md).
