...
public sealed record Reply(bool Ok, string State, string? Code=null, string? Error=null, bool TcpReady=false, string? Transport=null, bool AwgReady=false,bool Automatic=false,bool FriendsReady=false,string? Device=null);
