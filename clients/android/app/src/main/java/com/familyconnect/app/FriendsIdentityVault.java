...
final class FriendsIdentityVault {
    private static final String ALIAS = "family-connect-friends-identity-v1";
    private static final Object LOCK = new Object();
    private final AtomicFile file;
    FriendsIdentityVault(Context context) {
        file = new AtomicFile(new File(context.getNoBackupFilesDir(), "friends-identity.enc"));
    }
