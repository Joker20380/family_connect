...
final class ControlEnrollmentVault implements ControlJournal.Storage {
    private static final String ALIAS = "family-connect-control-enrollment-v1";
    private final AtomicFile file;
    ControlEnrollmentVault(Context context) {
        file = new AtomicFile(new File(context.getNoBackupFilesDir(), "control-enrollment.enc"));
    }
