"""Regenerate historical dodecahedron artwork only; current launchers use the door mark."""
...
(p/'clients/assets/dodecahedron.svg').write_text(svg+'</svg>\n');im=im.resize((256,256),Image.Resampling.LANCZOS);im.save(p/'clients/assets/dodecahedron.png')
