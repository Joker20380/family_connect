...
На странице приглашения доступны Android beta50 и Linux0.2.10 / Windows0.2.13 preview.
Установите приложение, вернитесь к исходной ссылке, отметьте **Приложение установлено** и нажмите **Открыть приложение**.
[Установка desktop](docs/clients.ru.md) · [Проверки выпуска](docs/releases/2026-09-23-windows0213-updater.ru.md).

Windows0.2.13 вводит отдельный подписанный канал обновлений. С0.2.12 и старше нужно один раз установить её вручную; следующие Windows-выпуски доступны через «Проверить обновления». Исправления перерисовки сохранены.
...
| Windows x64 | Нативный пилотный клиент; установщик 0.2.13 sourcec298436. Активация по ссылке; доверенной подписи издателя пока нет. |
...
**Состояние исходников:** этот checkpoint включает Android beta50 и Linux0.2.10 / Windows0.2.13 preview. Проверки и ограничения описаны в [отчёте](docs/releases/2026-09-23-switch-colors-beta50.ru.md). CI использует тестовую подпись; побайтовая воспроизводимость опубликованной APK не заявляется. Linux остаётся manual preview. Windows0.2.13 использует отдельный подписанный каталог после одной ручной установки переходной версии.
