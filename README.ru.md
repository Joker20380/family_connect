...
На странице приглашения доступны Android beta50 и Linux/Windows0.2.10 preview.
Установите приложение, вернитесь к исходной ссылке, отметьте **Приложение установлено** и нажмите **Открыть приложение**.
[Установка desktop](docs/clients.ru.md) · [Проверки выпуска](docs/releases/2026-09-23-desktop0210-rollout.ru.md).
...
| Windows x64 | Нативный пилотный клиент; установщик 0.2.10 preview840181d. Активация по ссылке; доверенной подписи издателя пока нет. |
...
**Состояние исходников:** этот checkpoint включает Android beta50 и Linux/Windows0.2.10 preview. Проверки и ограничения описаны в [отчёте](docs/releases/2026-09-23-switch-colors-beta50.ru.md). CI использует тестовую подпись; побайтовая воспроизводимость опубликованной APK не заявляется. Desktop0.2.10 распространяется как manual preview; автоматические каталоги остаются отдельным каналом.
