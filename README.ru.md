...
**Состояние исходников:** публичная ветка main пока отстаёт от распространяемой Android beta49. Возможности выше относятся к проверенной APK; сборка main не воспроизводит эту версию. Публикация соответствующего состояния исходников включена в [план](docs/PLAN.md).
