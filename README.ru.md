...
На странице приглашения доступны Android beta50 и Linux0.2.10 / Windows0.2.12 preview.
Установите приложение, вернитесь к исходной ссылке, отметьте **Приложение установлено** и нажмите **Открыть приложение**.
[Установка desktop](docs/clients.ru.md) · [Проверки выпуска](docs/releases/2026-09-23-windows0212-repaint.ru.md).

Windows0.2.12 исправляет перерисовку при выборе страны и транспорта: списки выводятся одним готовым кадром, лишнее обновление шапки убрано.
...
| Windows x64 | Нативный пилотный клиент; установщик 0.2.12 previewa584e54. Активация по ссылке; доверенной подписи издателя пока нет. |
...
**Состояние исходников:** этот checkpoint включает Android beta50 и Linux0.2.10 / Windows0.2.12 preview. Проверки и ограничения описаны в [отчёте](docs/releases/2026-09-23-switch-colors-beta50.ru.md). CI использует тестовую подпись; побайтовая воспроизводимость опубликованной APK не заявляется. Desktop preview распространяется как manual preview; автоматические каталоги остаются отдельным каналом.
