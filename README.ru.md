...
На странице приглашения доступны Android beta50 и Linux0.2.10 / Windows0.2.11 preview.
Установите приложение, вернитесь к исходной ссылке, отметьте **Приложение установлено** и нажмите **Открыть приложение**.
[Установка desktop](docs/clients.ru.md) · [Проверки выпуска](docs/releases/2026-09-23-windows0211-dpi.ru.md).
...
| Windows x64 | Нативный пилотный клиент; установщик 0.2.11 preview8906d62. Активация по ссылке; доверенной подписи издателя пока нет. |
