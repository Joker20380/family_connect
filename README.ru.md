...
Android **0.1.18-beta49** доступен для обновления: голосовые, запись удержанием,
фиксация свайпом вверх, правки текста и фоновые уведомления. Новые сообщения
автоматически показываются в чате. [Установка и обновление](docs/getting-started.ru.md)
· [Версии и контрольные суммы](docs/releases.md).

Страница приглашения пока устанавливает beta35 с активацией кодом. Новый пользователь
сначала активирует её, затем обновляется до49 поверх приложения. Новый вход по ссылке
и desktop0.2.10 ожидают согласованного выпуска; публичные Linux/Windows пока0.2.9.

## Платформы

| Платформа | Что доступно сейчас |
| --- | --- |
| Android 8+ | Beta49; ARM64 APK, 36,4 МБ. VPN, текст и голосовые проверены; первая активация пока через beta35. |
...
Тестовая Android beta38, русский интерфейс, 23 сентября 2026 года. Настоящий нативный экран с устройства; на кадре VPN выключен. Исторический снимок; актуальное обновление — beta49. [Происхождение изображения](docs/assets/README.md).
...
- [Android beta и контрольная сумма](docs/releases/2026-09-23-voice-scroll-beta49.ru.md)
...
**Состояние исходников:** этот checkpoint включает Android beta49 и кандидат Linux/Windows0.2.10. Проверки и ограничения описаны в [отчёте](docs/releases/2026-09-23-source-checkpoint.ru.md). CI использует тестовую подпись; побайтовая воспроизводимость опубликованной APK не заявляется. Публичные desktop загрузки остаются0.2.9 до согласованного выпуска.
